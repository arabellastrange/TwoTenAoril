...
>>>>>>> cdb136e5d8f4fd2d4ad0c654842d25186e75d38c
...
void save_history_to_file() {
	...
	// The 20 should be replaced with the number of commands in the history.
	for(int i = 0; i < 20; i++) {
		// For each item in the history, add it the the file.
...
=======
	...
	for(int i = 0; i < 20; i++) {
		...
		// Seprate the string into the two sections.
		history[i].history_number = (int)strtok(command_from_file, ":");
